...
public class First_test {
    ...
    @Test
    public void testPaymetConfirmited() {
        driver.get(baseUrl);
        ...
        cardHolder.click();
        cardHolder.clear();
        cardHolder.sendKeys("SHALIMOVA NADEZDA");
        cardMonth.click();
        new Select(cardMonth).selectByVisibleText("11");
        cardYear.click();
        new Select(cardYear).selectByVisibleText("2022");
        cardCvc.click();
        cardCvc.clear();
